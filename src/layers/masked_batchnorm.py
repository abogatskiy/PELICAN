...
class MaskedBatchNorm1d(nn.BatchNorm1d):
    ...
    def forward(self, inp, mask):
        ...
        assert len(mask.shape) == 2, f'Expected 3 dimensions in mask, instead got {len(mask.shape)} and shape {mask.shape}'
...
class MaskedBatchNorm2d(nn.BatchNorm2d):
    ...
    def forward(self, inp, mask):
        ...
        assert len(mask.shape) == 4, f'Expected 3 dimensions in mask, instead got {len(mask.shape)} and shape {mask.shape}'
